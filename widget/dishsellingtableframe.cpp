#include "dishsellingtableframe.h"
#include "ui_dishsellingtableframe.h"

DishSellingTableFrame::DishSellingTableFrame(QWidget *parent) :
    QFrame(parent),
    ui(new Ui::DishSellingTableFrame)
{
    ui->setupUi(this);
...
DishSellingTableFrame::~DishSellingTableFrame()
{
    delete ui;
}

void DishSellingTableFrame::changeEvent(QEvent *ev)
{
...
QLabel *DishSellingTableFrame::getIconLabel()
{
    return ui->labelIcon;
}

void DishSellingTableFrame::setName(const QString &name)
{
    ui->labelName->setText(name);
}

void DishSellingTableFrame::setGroupColors(const QList<QColor> &groupColorList)
{
...
void DishSellingTableFrame::resetStyle()
{
    for(int i=0; i<groupLabelList.size(); i++)
    {
